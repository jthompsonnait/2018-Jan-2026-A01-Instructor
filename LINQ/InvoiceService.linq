...
public class Library
{
	...
	public Result<InvoiceView> AddEditInvoice(InvoiceView invoiceView)
	{
		...
		//	process each line item in the provided lines view model
		foreach (var invoiceLineView in invoiceView.InvoiceLines)
		{
			...
			//	handle a new of existing line item
			...
			{
				//invoice.SubTotal = invoice.SubTotal + (invoiceLine.Quantity * invoiceLine.Price);
		...
		//	if it is a new invoice, add it to the database
		...
		{
			//	clear changes to maintain data intgrity
